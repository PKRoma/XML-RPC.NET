...
namespace CookComputing.XmlRpc
{
  ...
  public class AsyncResultWithTimeout<TResult> : AsyncResult<TResult>
  {
    // Field set when operation completes
    private TResult m_result = default(TResult);
    ...
    protected AsyncResultWithTimeout(
        AsyncCallback asyncCallback,
        object state,
        object owner,
        string operationId,
      ...
      base(asyncCallback, state, owner, operationId)
    {
      ThreadPool.RegisterWaitForSingleObject(AsyncWaitHandle,
        (o, b) =>
        {
          TimedOut();
          Complete(new TimeoutException());
        },
        state, timeout, true);
